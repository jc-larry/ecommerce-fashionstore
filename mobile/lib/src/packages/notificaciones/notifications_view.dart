  ...
  Future<void> _loadNotifications() async {
    ...
    try {
      ...
      if (token == null) {
        setState(() {
          _loading = false;
          _error = 'Inicia sesión para consultar tus notificaciones.';
        });
        return;
      }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              const Text('Sin notificaciones recientes', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: _ink)),

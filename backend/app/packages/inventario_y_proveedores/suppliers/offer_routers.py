...
from app.packages.inventario_y_proveedores.suppliers.offer_models import SupplierOffer, SupplierReorderRequest, SupplierProductStatus
...
from app.packages.catalogo_y_tiendas.models import Product, ProductVariant, ProductImage
from app.packages.seguridad_y_usuarios.models import User
from app.packages.seguridad_y_usuarios.routers import get_current_user, RoleChecker, _resolve_branch_id

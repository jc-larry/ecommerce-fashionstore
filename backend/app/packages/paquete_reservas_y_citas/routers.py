...
from app.packages.paquete_catalogo_y_tiendas.models import Product, ProductVariant, Size, Color
...
from app.packages.paquete_reservas_y_citas.schemas import (
    ReservationCreate,
    ReservationResponse,
...
from app.packages.paquete_seguridad_usuarios.routers import get_current_user, _resolve_branch_id

...
from app.packages.paquete_catalogo_y_tiendas.branches.schemas import BranchCreate, BranchUpdate, BranchResponse, AssignEmployee
# Importar control de roles, usuario y logueo de auditoría del paquete de Seguridad
from app.packages.paquete_seguridad_usuarios import User, RoleChecker, log_event, assign_user_to_branch

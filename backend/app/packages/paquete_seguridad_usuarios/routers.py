...
from app.packages.paquete_seguridad_usuarios.services import verify_password, get_password_hash, create_access_token, decode_access_token
from app.packages.paquete_seguridad_usuarios.models import User, Role, SessionToken, AuditLog
from app.packages.paquete_notificaciones import send_password_recovery_email
import secrets
from app.packages.paquete_seguridad_usuarios.schemas import (
...
def _resolve_branch_id(current_user: User, db: Session) -> Optional[int]:
    ...
    """
    from app.packages.paquete_catalogo_y_tiendas.branches.models import branch_employees
    row = db.execute(
...
def _resolve_supplier_id(current_user: User, db: Session) -> Optional[int]:
    ...
    """
    from app.packages.paquete_inventario_y_proveedores.suppliers.models import supplier_employees
    row = db.execute(

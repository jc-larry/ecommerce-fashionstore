...
from app.packages.paquete_inventario_y_proveedores.suppliers.models import Supplier, supplier_employees
from app.packages.paquete_inventario_y_proveedores.suppliers.schemas import (
    SupplierCreate, SupplierUpdate, SupplierResponse, SupplierContactUpdate, AssignSupplierUser,
)
from app.packages.paquete_inventario_y_proveedores.merchandise.models import PurchaseOrder, PurchaseDetail, Inventory
from app.packages.paquete_inventario_y_proveedores.merchandise.schemas import SupplierProductAvailability
...
from app.packages.paquete_inventario_y_proveedores.suppliers.offer_routers import (
...
from app.packages.paquete_seguridad_usuarios import User, RoleChecker, log_event, get_supplier_scope, SupplierScope
